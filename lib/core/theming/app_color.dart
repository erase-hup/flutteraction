...
class ColorManager {
  ...
  static const lightPrimaryColor = Color(0xff7CB0FF);
  static const darkPrimaryColor = Color(0xff5096FF);

  static const backgroundColor = Color(0xffFFFFFF);

  static const secondaryColor = Color(0xffE9FAEF);
  ...
  static Color greyDisplayTextDark = const Color(0xffD9D9D9);

  static Color borderColor = const Color(0xff413147);
